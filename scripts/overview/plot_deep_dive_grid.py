...
Reads (default GRID_VARIANT=acs):
  workspace/overview/p_first_hc_first/stat_grid/<GRID_VARIANT>/stat_grid_long.csv
  workspace/overview/p_first_hc_first/stat_grid/<GRID_VARIANT>/cell_header_stats.csv

Outputs:
  workspace/overview/p_first_hc_first/stat_grid/<GRID_VARIANT>/stat_grid.png
  workspace/overview/p_first_hc_first/stat_grid/<GRID_VARIANT>/stat_grid_markdown.md
...
DEEP = ROOT / "workspace" / "overview" / "p_first_hc_first" / "stat_grid" / _variant
