...
Reads (default GRID_VARIANT=acs):
  workspace/overview/<cohort>/stat_grid/<GRID_VARIANT>/stat_grid_long.csv
  workspace/overview/<cohort>/stat_grid/<GRID_VARIANT>/cell_header_stats.csv

Outputs:
  workspace/overview/<cohort>/stat_grid/<GRID_VARIANT>/stat_grid.png
  workspace/overview/<cohort>/stat_grid/<GRID_VARIANT>/stat_grid_markdown.md
