...
description: scripts/literature_monitor/ 套件，4 topic × 4 source，references/waiting_review/ 二篩
type: project
originSessionId: 3de60f8b-ee46-4b16-a6aa-7a8eebca3121
---
`scripts/literature_monitor/` 自動追蹤 4 面向（embedding/asymmetry/emotion/age）× 4 source（arXiv/S2/PubMed/OpenAlex），PDF 下載到 `references/waiting_review/<topic>/<YYYYMMDD>/`。
