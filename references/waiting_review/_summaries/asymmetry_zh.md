...
共 12 篇（Ko 2021 / Pucciarelli 2018 dupe 已合併）。
...
## 10. [--] **Pucciarelli 2018** — Stereophotogrammetric Analysis of the Human Face: A Tool for Modern Morphologists

> PhD thesis (Università degli Studi di Milano)

新科技（雷射掃描、stereophotogrammetry）對人體測量學貢獻顯著。Stereophotogrammetry 準確、可重複、快、非侵入，已廣泛應用於醫學。臉部測量可可靠提供形態學細節（畸形、底層病理特徵），對神經疾病有時提供 genotype/phenotype 相關性洞察，也可為 maxillo-facial 與牙科治療提供客觀計畫評估參數。

**論文設計**：用 VECTRA M3 3D stereophotogrammetric 系統做 5 個研究：
1. Dravet 症候群成人臉部
2. GLUT-1 DS 病人 3D 顱面測量
3. 全前腦症一例
4. 淋巴管畸形治療後唇對稱
5. 面部復原評估新法

**結論**：3D 臉部分析在罕見症候群診斷、術後追蹤、客觀 maxillo-facial 評估有實用價值。

> 與 AD 連結弱，主要是 craniofacial 罕病與重建外科應用。對我們 project 直接相關性低。
...
## 12. [PT] **Yoonesi 2025** — Facial Expression Deep Learning Algorithms in the Detection of Neurological Disorders: A Systematic Review and Meta-Analysis
