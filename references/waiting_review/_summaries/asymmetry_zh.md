...
排列：本檔按 review status — #1 核心、#2-3 方法論參考、#4-6 延伸-induction、#7-8 延伸-review、#9-11 邊緣。
...
## 2. [--] **Brown 2019** — The Face of Early Cognitive Decline? Shape and Asymmetry Predict Choice Reaction Time Independent of Age, Diet or Exercise
...
## 3. [PT] **Yoonesi 2025** — Facial Expression Deep Learning Algorithms in the Detection of Neurological Disorders: A Systematic Review and Meta-Analysis
...
## 4. [--] **Heinrich 2026** — AI-Based Angle Map Analysis of Facial Asymmetry in Peripheral Facial Palsy
...
## 5. [PT] **Jafari 2022** — 3D Video Tracking Technology in the Assessment of Orofacial Impairments in Neurological Disorders
...
## 6. [--] **Ko 2021** — Changes in Computer-Analyzed Facial Expressions with Age
...
## 7. [PT] **Al-baker 2023** — Accuracy and Reliability of Automated 3D Facial Landmarking in Medical and Biological Studies — A Systematic Review
...
## 8. [PT] **Obrochta 2025** — Is the Human Face a Biomarker of Health? — A Scoping Review
...
## 9. [--] **Al-baker 2025** — The Accuracy of Automated Facial Landmarking — A Comparative Study Between Cliniface Software and Patch-based CNN
...
## 10. [--] **Liu 2025** — Genetic Insights of Image-Based Traits: Analysis Pipeline for AI-based Phenotyping, Combined-GWAS, and Federated Learning with Application to the Human Face
...
## 11. [PT] **Yang 2025** — Motor Symptoms of Parkinson's Disease: Critical Markers for Early AI-Assisted Diagnosis
