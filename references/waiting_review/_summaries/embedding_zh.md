...
共 4 篇（Grimmer 2021 Face Age Progression survey 已 archive — 影像合成而非測量，與 AD biomarker 方向不符）。
...
## 4. [--] **Okunishi 2025** — Dementia and MCI Detection Based on Comprehensive Facial Expression Analysis From Videos During Conversation
